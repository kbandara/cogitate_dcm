function s01_prepro_b1(p_name) 
%% Pre-Processing of MEG data 

% pre-processing of MEG data - batch 1
...
P_Names_all = P_Names_table{:, 1}';%{'CA107'}; 
P_Names = {P_Names_all{p_name}}; %single p-name for this job
runs = {'01','02','03','04','05'};
...
for cc = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{cc} '/ses-1/meg/'];
    cd(filepath)
...
for ds = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{ds} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for xx = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{xx} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for aa = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{aa} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
%{  
...
for pp = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{pp} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for ms = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{ms} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
%{  
    %Initialize list of files to delete for this participant after this stage <<<
...
for rr = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{rr} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for ra = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{ra} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for lf = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{lf} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for bc = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{bc} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for select = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{select} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
for notarget = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{notarget} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
...
filepath = '/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessed_files/';
cd(filepath)
...
for move = 1:length(P_Names)
    ...
    filepath = ['/data/gpfs/projects/punim2118/Cogitate_DCM/Cogitate_Data/COG_MEEG_EXP1_BIDS_BATCH1/derivatives/preprocessing/sub-' P_Names{move} '/ses-1/meg/spm_preprocessed_files/'];
    cd(filepath)
